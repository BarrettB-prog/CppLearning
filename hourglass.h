...
{
   public:
    Hourglass();                // when run without params, will set to default values seen below. Set in .cpp file
   ...
   private:
    int Size;      //triangles involved are equilateral so only 1 side length is needed
    char BorderChar;
    char FillChar;
